...
<div class='form-group'>
      ...
      <div class='col-sm-10'>          
        <input type='file'  name='fname' value='".$bllog['log']."' class='form-control' id='pwd' >
      </div>
    </div>
...
@$size = $_FILES['fname'] ['size'] ;
	...
	if (@$_POST['text']=="")
		...
		$text=$_POST['text'];
		  ...
		  if ( isset($_POST['sbmt']))
		  {
			  $upQuery="update service set text='".strip_tags($text)."', log='".$image_find."'  where id =".$_GET['id'] ;
